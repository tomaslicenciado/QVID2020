...
public:
    ...
    void setupUi(QWidget *Interfaz)
    {
        ...
        gridLayout->addLayout(gridLayout_8, 15, 0, 1, 4);
        ...
        gridLayout->addLayout(gridLayout_9, 15, 7, 1, 1);
        ...
        gridLayout->addLayout(gridLayout_4, 12, 7, 1, 1);
        ...
        gridLayout->addLayout(gridLayout_2, 5, 7, 2, 1);
        ...
        gridLayout->addLayout(gridLayout_5, 10, 7, 1, 1);
        ...
        gridLayout->addItem(verticalSpacer_3, 9, 7, 1, 1);

        verticalSpacer = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout->addItem(verticalSpacer, 8, 0, 3, 1);
        ...
        gridLayout->addWidget(pbComparar, 15, 6, 1, 1);

        verticalSpacer_5 = new QSpacerItem(20, 40, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout->addItem(verticalSpacer_5, 8, 7, 1, 1);
        ...
        gridLayout->addLayout(gridLayout_3, 12, 0, 1, 1);
